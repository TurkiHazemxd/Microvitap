...
exports.DistributorsModule = DistributorsModule = __decorate([
    (0, common_1.Module)({
        imports: [
            mongoose_1.MongooseModule.forFeature([{ name: distributor_schema_1.Distributor.name, schema: distributor_schema_1.DistributorSchema }]),
        ],
        controllers: [distributors_controller_1.DistributorsController],
        providers: [distributors_service_1.DistributorsService],
        exports: [distributors_service_1.DistributorsService],
    })
], DistributorsModule);
