...
let AuthController = class AuthController {
    ...
    async requestReset(requestResetDto) {
    ...
    async resetPasswordWithCode(resetPasswordWithCodeDto) {
        await this.authService.resetPasswordWithCode(resetPasswordWithCodeDto.email, resetPasswordWithCodeDto.code, resetPasswordWithCodeDto.newPassword);
        return {
            success: true,
